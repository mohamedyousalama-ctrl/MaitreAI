...
Each row resolves the corresponding scope question. Evidence states are those defined in KIVO_STATE-01 §1 and are quoted at the §55ed299 baseline; none is upgraded by this register.
