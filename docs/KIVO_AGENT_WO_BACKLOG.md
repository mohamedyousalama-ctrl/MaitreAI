...
| `AGENT-WO-009` | Egyptian Arabic golden-scenario corpus | KIVO-PM + founder | `AGENT-WO-008` inventory plus founder-reviewed expected behaviour | Reviewed scenarios with expected behaviour signed off | not started | **PLANNED** | Request the approving work order |
