...
**Last updated:** 11 August 2026 — `AGENT-WO-002` M-0–M-4 pre-maintenance specification and proof design cleared and taken into durable repository custody under `docs/governance/`; governance and custody only, no implementation authority<br>
