...
const GUIDANCE: Record<string, AlertGuidance> = {
  ...
  webhook_tenant_resolution_failed: {
    what: "وصلت رسالة واتساب لكن النظام لم يجد مطعماً صريحاً يربطها به، فتم إيقافها بدل إرسالها لمطعم غلط.",
    action: "بلّغ فارس فوراً ليتأكد من WHATSAPP_RESTAURANT_ID أو ALERT_PLATFORM_RESTAURANT_ID في إعدادات الإنتاج.",
  },
  agent_error_rate: {
