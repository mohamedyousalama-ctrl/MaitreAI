...
import { FRAME_WORDS } from "./symptom-frames";
...
const SYMPTOM_TERMS: { re: RegExp; label: string }[] = [
  ...
  { re: new RegExp("(?:اختناق|(?:بت|بي)خنق(?:ني)?|ب(?:خت|خ)نق(?:ني)?|(?:ب)?اتخنق[ت]?|خنق[هة]|نفسي\\s+(?:بيقف|بيتقطع)|مش\\s+لاحق\\s+نفسي|كتم[هة](?:\\s+(?:في\\s+)?(?:صدر|نفس|حلق|زور))|(?:" + FRAME_WORDS + ")\\s*كتم[هة]|صدري\\s+بيقفل|صفير\\s+في\\s+النفس|ازم[هة]\\s+صدر|(?<![ء-ي])(?:ال)?ربو(?![ء-ي]))"), label: "ضيق في التنفس" },
  ...
  { re: new RegExp("(?:(?:" + FRAME_WORDS + ")[^.،,؛!؟\\n]{0,20}(?<![ء-ي])(?:و|ف|ب|ك|ل)?(?:ال)?(?:طفح|حكه)(?![ء-ي])|(?<![ء-ي])(?:و|ف|ب|ك|ل)?(?:ال)?(?:طفح|حكه)(?![ء-ي])[^.،,؛!؟\\n]{0,20}(?:جلد|بشرت|جسم|وجهي|وشي|ايدي|يدي|رقبت|صدري|بطني|رجلي|لسان|حلق|زور|حنجرت|بلعوم|شفايف|شفت|عين|عيون|خدي|خده|انف|منخار)|(?:جلدي|بشرتي|جسمي|وجهي|وشي|ايدي|يدي|رقبتي|صدري|بطني|رجلي|لساني|حلقي|زوري|حنجرتي|بلعومي|شفايفي|شفتي|عيني|خدي|انفي|منخاري)[^.،,؛!؟\\n]{0,12}(?<![ء-ي])(?:و|ف|ب|ك|ل)?(?:ال)?(?:طفح|حكه)(?![ء-ي]))"), label: "طفح جلدي" },
  { re: /(?<![ء-ي])(?:و|ف|ب|ك|ل)?(?:ال)?حبوب(?![ء-ي])(?=[^.،,؛!؟\n]{0,24}(?:جلد|وجه|وشي|وشه|بشر|جسم|ايد|يدي|رقب|صدر|رجل|شفايف|شفت|لسان|حلق|زور|عين|خدي|خده|انف|من\s+(?:ال)?(?:اكل|طعام|وجب|صنف|طبق)))|(?:جلدي|وجهي|وشي|بشرتي|جسمي|ايدي|رقبتي)[^.،,؛!؟\n]{0,12}(?<![ء-ي])حبوب(?![ء-ي])|(?:طلع|طلعت|ظهر|ظهرت|جاني|جاتني)\s*(?:لي|لنا)?\s*(?:ال)?حبوب(?![ء-ي])/, label: "طفح جلدي" },
  ...
  { re: new RegExp("(?:(?:" + FRAME_WORDS + ")[^.،,؛!؟\\n]{0,12}احمرار|احمرار[^.،,؛!؟\\n]{0,12}(?:جلد|وجه|وشي|وشه|بشر|جسم|ايد|يدي|رقب|عيون|عين|شفا|خدي|خده|لسان|حلق|زور|حنجرت|بلعوم|انف|منخار)|(?:جلد|وجه|وشي|وشه|بشر|جسم|ايد|يدي|رقب|عيون|عين|شفا|خدي|خده|صدر|رجل|لسان|حلق|زور|حنجرت|بلعوم|انف|منخار)\\S*[^.،,؛!؟\\n]{0,12}احمرار|ارتي?كاريا|جسم[يه]\\s+بيقلب|بقع\\s+حمرا)"), label: "طفح جلدي" },
