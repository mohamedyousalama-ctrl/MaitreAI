...
export const FORBIDDEN_CLAIMS = [
  ...
  },
  {
    ...
    re: /(?:أعطني|اعطني|عطني|أرسل|ارسل|زوّدني|زودني|اكتب|أدخل|ادخل|هات|ابعت|ابعتلي|محتاج|أحتاج|احتاج|ممكن|أبي|أبغى|ابغى)\s*(?:لي\s+)?(?:\S+\s+){0,3}(?:رقم\s+(?:ال)?بطاق|رقم\s+(?:ال)?كرت|(?:ال)?رقم\s+السري|(?:رمز|رموز)\s+(?:التحقق|الأمان|الحماي[ةه])|بيانات\s+(?:ال)?بطاق|(?:cvv|cvc|otp|pin)\b)/i,
    evalAssert: true,
