...
// ============================================================================
// FbSdkLoader (console_v2) — loads the Facebook JS SDK exactly once per page
// lifecycle, ONLY when mounted (the واتساب onboarding step mounts it — never
// global). Ported from the reference branch feat/embedded-signup-frontend with
// the SDK-flow logic intact; the surface it feeds is the console_v2 onboarding.
//
...
//     - FB.init() `version` — we use "v19.0" to match the backend route
//       (GRAPH_API_VERSION). Update both if Meta bumps the required version.
...
/**
 * Invisible component. Mount once inside the WhatsApp step (never globally).
