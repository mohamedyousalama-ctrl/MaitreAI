...
// ============================================================================
// MaitreAI — Login form (client). Email/phone OTP via Supabase. Extracted from
// the login page so the page can be a SERVER component that reads the request
// host and renders host-aware branding around this form (operator hosts show
// Wesaya branding + no City Baker footer). The auth logic here is UNCHANGED.
// ============================================================================
