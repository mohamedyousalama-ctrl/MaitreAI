...
--
-- NOTE: re-ported from the pre-divergence PR #6 onto current main; renumbered
-- 0016 → 0031 to land after 0030_eightysix. The drivers/deliveries/
-- delivery_locations/delivery_events schema is ALREADY APPLIED to production
-- (verified col-for-col) — the IF NOT EXISTS / DROP POLICY guards make a re-run a
-- parity no-op. Kept in-repo for parity.
-- ============================================================================
