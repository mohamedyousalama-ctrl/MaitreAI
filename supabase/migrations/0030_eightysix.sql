...
-- Tenant-scoped + RLS consistent with the app. Idempotent.
--
-- NOTE: this schema is ALREADY APPLIED to production (re-ported from the
-- pre-divergence PR #7 onto current main; renumbered 0019 → 0030 to land after
-- 0029_cod_ledger). Kept in-repo for parity; the IF NOT EXISTS / DROP POLICY
